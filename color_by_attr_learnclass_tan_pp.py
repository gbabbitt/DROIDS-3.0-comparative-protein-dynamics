...
model = "1"
pdb_file = "%s.pdb" % (rID)
pdb_file_bound = "%s.pdb" % (qID)
attr_file = "attribute_files/classATTR_%s_mask.dat" % (rID)
...
# open again and align with bound protein
mol = chimera.openModels.open(pdb_file_bound)[0] # Opens molecule
rc("mm #1 #2")
